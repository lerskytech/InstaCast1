  ...
  return (
    <div className="home-container">
      ...
      <footer>
        ...
        <button className="help-button" onClick={openHelpModal}>About / Help</button>
      </footer>

      <Modal
        isOpen={isHelpModalOpen}
        onClose={closeHelpModal}
        title="About Instacast"
      >
        <div className="help-content">
          ...
          <p>
            All communication happens directly between devices, not through our servers.
            Session codes are randomly generated and temporary for each session.
          </p>
        </div>
      </Modal>
    </div>
